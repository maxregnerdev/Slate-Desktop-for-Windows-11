...
class FluentDesign3Module:
    ...
    def install_dependencies(self) -> bool:
        ...
        # Install via winget
        winget_commands = [
            'winget install --id Maplespe.ExplorerBlurMica --accept-package-agreements --accept-source-agreements --silent',
            'winget install --id Maplespe.DWMBlurGlass --accept-package-agreements --accept-source-agreements --silent',
            'winget install --id MicaForEveryone.MicaForEveryone --accept-package-agreements --accept-source-agreements --silent'
        ]
        ...
        if success_count < len(winget_commands):
            ...
            print(f"    Run: winget install --id Maplespe.ExplorerBlurMica")
            print(f"    Run: winget install --id Maplespe.DWMBlurGlass")
            print(f"    Run: winget install --id MicaForEveryone.MicaForEveryone")
